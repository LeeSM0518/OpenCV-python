...
imgBGR5 = cv2.imread(path+'baboon.jpg')
imgBGR6 = cv2.imread(path+'orange.jpg')
...
imgRGB5 = cv2.cvtColor(imgBGR3, cv2.COLOR_BGR2RGB)
imgRGB6 = cv2.cvtColor(imgBGR4, cv2.COLOR_BGR2RGB)
...
ax[1][2].axis("off")
ax[1][2].imshow(imgRGB3, aspect = "auto")

ax[0][2].axis("off")
ax[0][2].imshow(imgRGB4, aspect = 'auto')
